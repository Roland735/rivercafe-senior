...
export default function ItSidebar({ isCollapsed, toggleSidebar, onItemClick }) {
  ...
  const items = [
    { href: "/it", label: "Dashboard", icon: <FiHome /> },
    { href: "/it/reset-password", label: "Reset Password", icon: <FiList /> },
  ];
